...
angular.module('app.main', [])
	...
	.directive('action', ['$cookies', function($cookies) {
		return {
			restrict: 'A',
			link: function(scope, element, attrs) {
				/*
				...
				var smartActions = {
				    ...
				    resetWidgets: function($this){
						...
						$.SmartMessageBox({
							title : "<i class='fa fa-refresh' style='color:green'></i> 刷新",
	...
	.factory('localize', ['$http', '$rootScope', '$window', function($http, $rootScope, $window){
		var localize = {
			...
			getLangUrl: function(lang) {
				return 'media/js/langs/' + lang.langCode + '.js';
			},
...
angular.module('app.navigation', [])
	...
	.controller('NavItemController', ['$scope', '$location', function($scope, $location) {
		$scope.isChild = false;
		$scope.active = false;
